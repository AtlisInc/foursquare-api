 ...
 *
 * @see
 * <a href="https://developer.foursquare.com/docs/index_docs.html" target="_blank">https://developer.foursquare.com/docs/index_docs.html</a>
 */
public class FoursquareApi {
     ...
     *
     * @param skipNonExistingFields debugging flag what ever parser should
     * disregard non-existing fields
     */
     ...
     *
     * @param version Foursquare API version
     */
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/users/users.html" target="_blank">https://developer.foursquare.com/docs/users/users.html</a>
     *
     * @param userId User id (can be 'self' in case of the current user, assumed
     * 'self' if null)
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/users/leaderboard.html" target="_blank">https://developer.foursquare.com/docs/users/leaderboard.html</a>
     *
     * @param neighbors number of friends' scores to return that are adjacent to
     * user's score
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/users/badges.html" target="_blank">https://developer.foursquare.com/docs/users/badges.html</a>
     *
     * @param userId User id (can be 'self' in case of the current user, assumed
     * 'self' if null)
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/users/checkins.html" target="_blank">https://developer.foursquare.com/docs/users/checkins.html</a>
     *
     * @param userId User id (For now, only 'self' is supported, 'self' assumed
     * if null)
     * @param limit number of results to return
     * @param offset used to page through results.
     * @param afterTimestamp retrieve the first results to follow these seconds
     * since epoch.
     * @param beforeTimestamp retrieve the first results prior to these seconds
     * since epoch.
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/users/tips.html" target="_blank">https://developer.foursquare.com/docs/users/tips.html</a>
     *
     * @param userId User id (can be 'self' in case of the current user, assumed
     * 'self' if null)
     * @param sort one of recent, nearby, or popular. Nearby requires ll to be
     * provided.
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/users/todos.html" target="_blank">https://developer.foursquare.com/docs/users/todos.html</a>
     *
     * @param userId User id (can be 'self' in case of the current user, assumed
     * 'self' if null)
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/users/venuehistory.html" target="_blank">https://developer.foursquare.com/docs/users/venuehistory.html</a>
     *
     * @param userId User id (For now, only 'self' is supported, 'self' assumed
     * if null)
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/users/request.html" target="_blank">https://developer.foursquare.com/docs/users/request.html</a>
     *
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/users/unfriend.html" target="_blank">https://developer.foursquare.com/docs/users/unfriend.html</a>
     *
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/users/approve.html" target="_blank">https://developer.foursquare.com/docs/users/approve.html</a>
     *
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/users/deny.html" target="_blank">https://developer.foursquare.com/docs/users/deny.html</a>
     *
     * @param userId the user id of a pending friend.
     * @return CompleteUser entity wrapped in Result object
     * @throws FoursquareApiException when something unexpected happens
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/users/setpings.html" target="_blank">https://developer.foursquare.com/docs/users/setpings.html</a>
     *
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/users/search.html" target="_blank">https://developer.foursquare.com/docs/users/search.html</a>
     *
     ...
     * @param twitterSource a single Twitter handle. Results will be friends of
     * this user who use Foursquare.
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/users/requests.html" target="_blank">https://developer.foursquare.com/docs/users/requests.html</a>
     *
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/users/friends.html" target="_blank">https://developer.foursquare.com/docs/users/friends.html</a>
     *
     * @param userId User id (can be 'self' in case of the current user, assumed
     * 'self' if null)
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/venues/venues.html" target="_blank">https://developer.foursquare.com/docs/venues/venues.html</a>
     *
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/venues/explore.html" target="_blank">https://developer.foursquare.com/docs/venues/explore.html</a>
     *
     * @param ll latitude and longitude of the location in question, so response
     ...
     * @param section one of food, drinks, coffee, shops, or arts. Choosing one
     * of these limits results to venues with categories matching these terms.
     * @param query a search term to be applied against tips, category, tips,
     * etc. at a venue.
     * @param limit number of results to return, up to 50.
     * @param basis if present and set to friends or me, limits results to only
     * places where friends have visited or user has visited, respectively.
    ...
    /**
     * Provides a count of how many people are at a given venue. If the request
     * is user authenticated, also returns a list of the users there,
     * friends-first.
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/venues/herenow.html" target="_blank">https://developer.foursquare.com/docs/venues/herenow.html</a>
     *
     * @param venueId id of venue to retrieve
     * @param limit number of results to return, up to 500.
     * @param offset used to page through results.
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/venues/tips.html" target="_blank">https://developer.foursquare.com/docs/venues/tips.html</a>
     *
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/venues/photos.html" target="_blank">https://developer.foursquare.com/docs/venues/photos.html</a>
     *
     * @param venueId the venue you want photos for.
     * @param group pass checkin for photos added by friends on their recent
     * checkins. Pass venue for public photos added to the venue by anyone. Use
     * multi to fetch both.
     * @param limit number of results to return, up to 500.
     * @param offset used to page through results.
    ...
    public Result<PhotoGroup> venuesPhotos(String venueId, String group, Integer limit, Integer offset) throws FoursquareApiException {
        try {
            ...
            if (response.getMeta().getCode() == 200) {
//                result = gson.fromJson(response.getResponse().getJSONObject("photos").toString(), PhotoGroup.class);
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/venues/links.html" target="_blank">https://developer.foursquare.com/docs/venues/links.html</a>
     *
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/venues/marktodo.html" target="_blank">https://developer.foursquare.com/docs/venues/marktodo.html</a>
     *
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/venues/flag.html" target="_blank">https://developer.foursquare.com/docs/venues/flag.html</a>
     *
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/venues/proposeedit.html" target="_blank">https://developer.foursquare.com/docs/venues/proposeedit.html</a>
     *
     * @param id the venue id for which an edit is being proposed.
     ...
     * @param ll latitude and longitude of the user's location, as accurate as
     * is known.
     * @param primaryCategoryId the ID of the category to which you want to
     * assign this venue.
     * @return Result object
     * @throws FoursquareApiException when something unexpected happens
     */
    ...
    /**
     * Allows you to make changes to a venue (acting user must be a superuser or
     * venue manager). Any blank parameter deletes an old value, any unspecified
     * parameter does nothing.
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/venues/edit.html" target="_blank">https://developer.foursquare.com/docs/venues/edit.html</a>
     *
     * @param id the venue id for which an edit is being proposed.
     * @param name the name of the venue.
     * @param address the address of the venue.
     ...
     * @param ll latitude and longitude of the user's location, as accurate as
     * is known.
     * @param categoryId the ID of the category to which you want to assign this
     * venue.
     * @param twitter The twitter handle of the venue.
     * @param description A freeform description of the venue, up to 300
     * characters.
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/venues/add.html" target="_blank">https://developer.foursquare.com/docs/venues/add.html</a>
     *
     * @param name the name of the venue
     * @param address the address of the venue.
     * @param crossStreet the nearest intersecting street or streets.
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/venues/categories.html" target="_blank">https://developer.foursquare.com/docs/venues/categories.html</a>
     *
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/venues/search.html" target="_blank">https://developer.foursquare.com/docs/venues/search.html</a>
     *
     * @param ll latitude and longitude of the user's location. (Required for
     * query searches)
     * @param llAcc accuracy of latitude and longitude, in meters. (Does not
     * currently affect search results.)
     * @param alt altitude of the user's location, in meters. (Does not
     * currently affect search results.)
     * @param altAcc accuracy of the user's altitude, in meters. (Does not
     * currently affect search results.)
     ...
     * @param linkedId identifier used by third party specifed in providerId
     * parameter
     * @param radius Limit results to venues within this many meters of the
     * specified location. Maximum is 100 000 meters.
     * @param near Required if ll is not provided. A string naming a place in
     * the world. Will be geocodd. (required for query searches)
     ...
     * For example:
     *
     * public Response foursquareSearchNamed(@QueryParam("place") String place,
     *
     * @QueryParam("term") String searchTerm) { Map<String,String> searchParams
     * = new HashMap<String,String>(); FoursquareApi foursquareApi = new
     * FoursquareApi(<your client_id>, <your client_secret>,
     * <your redirecturl>); searchParams.put("near", place);
     * searchParams.put("query", searchTerm); searchParams.put("limit","50");
     * try { Result<VenuesSearchResult> result =
     * foursquareApi.venuesSearch(searchParams); if(result != null) { return
     * Response.ok(result.getResult()).build(); } } catch (Exception e) {
     * e.printStackTrace(); log.warning("Problem with foursquare search"); }
     ...
     * <a href="https://developer.foursquare.com/docs/venues/search.html" target="_blank">https://developer.foursquare.com/docs/venues/search.html</a>
     *
     * @param near the name of a city or town which can be geocoded by
     * foursquare
     * @param query a search term to be applied against titles.
     * @param limit number of results to return, up to 50.
     * @param intent one of checkin, match or specials
     ...
     * @param query
     * @param limit
     * @return Result<VenuesAutocompleteResult> -- this is only minivenues as
     * per the API!
     *
     */
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/venues/trending.html" target="_blank">https://developer.foursquare.com/docs/venues/trending.html</a>
     *
     * @param ll latitude and longitude of the user's location.
     * @param limit number of results to return, up to 50.
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/checkins/checkins.html" target="_blank">https://developer.foursquare.com/docs/checkins/checkins.html</a>
     *
     * @param checkinId the ID of the checkin to retrieve additional information
     * for.
     * @param signature when checkins are sent to public feeds such as Twitter,
     * Foursquare appends a signature (s=XXXXXX) allowing users to bypass the
     * friends-only access check on checkins. The same value can be used here
     * for programmatic access to otherwise inaccessible checkins.
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/checkins/add.html" target="_blank">https://developer.foursquare.com/docs/checkins/add.html</a>
     *
     * @param venueId the venue where the user is checking in. No venueid is
     * needed if shouting or just providing a venue name. Find venue IDs by
     * searching or from historical APIs.
     * @param venue if are not shouting, but you don't have a venue ID or would
     * rather prefer a 'venueless' checkin, pass the venue name as a string
     * using this parameter
     * @param shout a message about your check-in. The maximum length of this
     * field is 140 characters.
     * @param broadcast how much to broadcast this check-in, ranging from
     * private (off-the-grid) to public,facebook,twitter. Can also be just
     * public or public,facebook, for example. If no valid value is found, the
     ...
     * @return Checkin entity wrapped in Result object. Result also contains
     * list of Notifications related to this checkin.
     * @throws FoursquareApiException when something unexpected happens
     */
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/checkins/recent.html" target="_blank">https://developer.foursquare.com/docs/checkins/recent.html</a>
     *
     * @param ll latitude and longitude of the user's location, so response can
     * include distance.
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/checkins/addcomment.html" target="_blank">https://developer.foursquare.com/docs/checkins/addcomment.html</a>
     *
    ...
    /**
     * Remove a comment from a checkin, if the acting user is the author or the
     * owner of the checkin.
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/checkins/deletecomment.html" target="_blank">https://developer.foursquare.com/docs/checkins/deletecomment.html</a>
     *
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/tips/tips.html" target="_blank">https://developer.foursquare.com/docs/tips/tips.html</a>
     *
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/tips/add.html" target="_blank">https://developer.foursquare.com/docs/tips/add.html</a>
     *
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/tips/search.html" target="_blank">https://developer.foursquare.com/docs/tips/search.html</a>
     *
     * @param ll latitude and longitude of the user's location.
     * @param limit number of results to return, up to 500.
     * @param offset used to page through results.
     * @param filter if set to friends, only show nearby tips from friends.
     * @param query only find tips matching the given term, cannot be used in
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/tips/marktodo.html" target="_blank">https://developer.foursquare.com/docs/tips/marktodo.html</a>
     *
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/tips/markdone.html" target="_blank">https://developer.foursquare.com/docs/tips/markdone.html</a>
     *
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/tips/unmark.html" target="_blank">https://developer.foursquare.com/docs/tips/unmark.html</a>
     *
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/photos/photos.html" target="_blank">https://developer.foursquare.com/docs/photos/photos.html</a>
     *
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/photos/add.html" target="_blank">https://developer.foursquare.com/docs/photos/add.html</a>
     *
     * @param checkinId the id of a checkin owned by the user
     * @param tipId the id of a tip owned by the user
     * @param venueId the id of a venue, provided only when adding a public
     * photo of the venue
     * @param broadcast twitter, facebook or twitter,facebook if you want to
     * send to both.
     * @param ll latitude and longitude of the user's location.
     * @param llAcc accuracy of the user's latitude and longitude, in meters.
     * @param alt altitude of the user's location, in meters.
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/settings/set.html" target="_blank">https://developer.foursquare.com/docs/settings/set.html</a>
     *
     * @param settingId one of sendToTwitter, sendMayorshipsToTwitter,
     * sendBadgesToTwitter, sendToFacebook, sendMayorshipsToFacebook,
     * sendBadgesToFacebook, receivePings, receiveCommentPings.
     * @param value true or false
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/settings/all.html" target="_blank">https://developer.foursquare.com/docs/settings/all.html</a>
     *
     * @return Setting entity wrapped in Result object
     * @throws FoursquareApiException when something unexpected happens
     */
    ...
    /**
     * Gives details about a special, including text and whether it is unlocked
     * for the current user.
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/specials/specials.html" target="_blank">https://developer.foursquare.com/docs/specials/specials.html</a>
     *
     ...
     *
     * @see
     * <a href="https://developer.foursquare.com/docs/specials/search.html" target="_blank">https://developer.foursquare.com/docs/specials/search.html</a>
     *
     ...
     * @param params request parameters. URL parameters should be added in
     * parameter name, parameter value pairs and multipart parameters should be
     * added as instances of MultipartParameters
     * @return response
     ...
     * @param path API endpoint
     * @param auth whether request should send oAuthToken or not
     * @param params request parameters. Parameters should be added in parameter
     * name, parameter value pairs
     * @return response
     * @throws JSONException when JSON parsing error occurs
     * @throws FoursquareApiException when something unexpected happens
     */
